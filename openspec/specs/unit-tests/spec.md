...
Cover the extension's core logic — gesture tokenization, gesture serialization, operation resolution, and backup
validation — with a Vitest suite runnable via `npm test`.
