# platform-context-menu Specification

## Purpose

Make mouse gestures work on Linux and macOS, where the native context menu opens on right-button press instead of after
release, while keeping the existing Windows behavior unchanged and keeping the native context menu reachable through a
double right click.
